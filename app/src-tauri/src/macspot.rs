// Got this code from here: https://github.com/ahkohd/tauri-macos-spotlight-example
// Idk how it works, but it does.

use std::sync::Mutex;

use tauri::{Manager, PhysicalPosition, PhysicalSize, Window, WindowEvent, Wry};
...
pub fn init_macspot(window: Window<Wry>) {
...
pub fn show_macspot(window: Window<Wry>) {
    set_state!(
        window.app_handle(),
...
pub fn hide_macspot(window: Window<Wry>) {
